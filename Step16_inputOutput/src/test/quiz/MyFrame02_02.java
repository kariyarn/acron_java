...
public class MyFrame02_02 extends JFrame {
   
   public MyFrame02_02(String title) {
      super(title);
      ...
      readBtn.addActionListener((e2)->{
         ...
         try {
            ...
            e.printStackTrace();
             ...
             try {
            	 //만약 br이 null이면 또 오류가 날수도 있다.
            	 //NullPointException이 발생하면 fr.close()가 호출이 안될가능성이 있다.
