...
public class TextFrameInstruc extends JFrame implements ActionListener{
   //필요한 필드 정의하기
   JTextField inputName, inputAddr;
   DefaultTableModel model;
   JTable table;
   //생성자
   public TextFrameInstruc(String title) {
      super(title);
   ...
   public static void main(String[] args) {
      TextFrameInstruc f=new TextFrameInstruc("테스트 프레임");
